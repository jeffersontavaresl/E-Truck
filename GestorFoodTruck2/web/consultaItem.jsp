...
<html lang="pt-br">
    ...
    <body>
                    ...
                    <table class="tabela table table-borderless table-striped rounded-1">  
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><button type="button" class="btn" data-toggle="modal" data-target="#excluirDados" onclick="nrExcluir(<%out.write("" + c.getCodProduto());%>)">
        ...
        <!-- Função para confirmação da exclusão do item -->
        <script>
            function nrExcluir(item) {

...
<html lang="pt-br">
    ...
    <body>
                    ...
                    <table class="tabela table table-borderless table-striped rounded-1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><% out.write("<a href=editaFornecedor.jsp?codFornecedor=" + f.getCodFornecedor() + ">" + "<i class='far fa-edit'       style='color:blue'></i></a>");%></td> 
                                <td>
                                    <a type="button" id="botaoexcluir" 
                                        onclick="mostrarExclusao(<%out.write("" + f.getCodFornecedor());%>)">
        ...
        <script>
            ...
            function mostrarExclusao(fornecedor) {

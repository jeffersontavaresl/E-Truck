...
<html lang="pt-br">
    <head>
        ...
        <title>E-Truck Management - Editar Item</title>
        <!--FAVICON-->
                ...
                <div class="container-fluid">
                    ...
                    <div class="container-fluid border w-50 h-75 mt-5 mb-4" id="tabela">
                        ...
                        <div class="container-fluid mt-3 mr-4">
                            <form action="recebeEditaItens.jsp" method="POST">
                                <label>Nome do produto</label>
                                <input type="text" maxlength="30" class="form-control" name="nome" required 
                                       value="<%out.write(c.getDescProduto());%>" />
                                <br />
                                <label>Preço</label>
                                <input type="number" maxlength="5" class="form-control" name="vlr" required 
                                       value="<%out.write("" + c.getPreco());%>" />
                                <br />
                                <label>Código do Produto</label>
                                <input type="text" class="form-control" name="codProduto" readonly
                                ...
                                <div class="text-center mb-3">
                                    <input type="submit" value="Alterar" class="btn btn-primary"/>
                                    <a href="consultaItem.jsp" class="btn btn-danger">Cancelar</a>
                                </div>
                            </form>
                        </div>
                    </div>

...
<html lang="pt-br">
    ...
    <body>
                    ...
                    <table class="tabela table table-borderless table-striped rounded-1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><%out.write("<a href=editaPedFornecedor.jsp?codPedFornecedor=" + a.getCodPedFornecedor() + ">" + "<i class='far fa-edit'       style='color:blue'></i></a>");%></td> 
                                <td>
                                    <a type="button" id="botaoexcluir" 
                                       onclick="mostrarExclusao(<%out.write("" + a.getCodPedFornecedor());%>)">
        ...
        <script>
            ...
            function mostrarExclusao(pedfornecedor) {

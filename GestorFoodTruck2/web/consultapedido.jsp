                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="modalExclusao">Deseja cancelar o pedido?</h5>
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a class="btn text-white" style="background-color:rgb(58, 42, 148)"<%out.write(" href=cancelarPedido.jsp?codPedido=" + pc.getCodPedido() + ">" + "Cancelar");%> </a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>

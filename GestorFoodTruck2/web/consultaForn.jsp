...
<html lang="pt-br">
    <head>
        ...
        <title>E-Truck Management - Consultar Fornecedor</title>
        <!--FAVICON-->
    ...
    <body>
                    ...
                    <table class="tabela table table-borderless table-striped rounded-1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <!--EDITAR INSUMO-->
                                <td><%out.write("<a class='btn' href=editaFornecedor.jsp?codFornecedor=" + f.getCodFornecedor() + ">" + "<i class='far fa-edit'       style='color:blue'></i></a>");%></td>

                                <!--BOTÃO QUE INICIA O MODAL DE EXCLUSÃO DO INSUMO-->
                                <td><button type="button" class="btn" data-toggle="modal" data-target="#excluirDados" onclick="nrExcluir(<%out.write("" + f.getCodFornecedor());%>)">
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="modalExclusao">Deseja excluir o fornecedor?</h5>
        ...
        <script>
            function nrExcluir(fornecedor) {
                var link = document.getElementById("confirmar");
                link.href = "excluiFornecedor.jsp?codFornecedor=" + fornecedor;
            }
        </script>
        <!--JS - SIDEBAR-->
